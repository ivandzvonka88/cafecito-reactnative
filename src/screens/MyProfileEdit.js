                    ...
                    <View style={{marginBottom:24}}>
                        ...
                        <View style={{margin:30}}>
                            ...
                            <View style={{marginTop:16}}>
                                ...
                                <View style={style.inputcontainer}>
                                    <TextInput style={style.input} placeholder="Full Address" placeholderTextColor="white"></TextInput>
                                </View>
                                <View style={style.inputcontainer}>
                                    <TextInput style={style.input} placeholder="Apartment, Suite ,etc (Optional)" placeholderTextColor="white"></TextInput>
                                </View>
                                <View style={{display:'flex',flexDirection:'row'}}>
                                    <View style={[style.inputcontainer,{marginRight:15,flex:1}]}>
                                        <TextInput style={style.input} placeholder="City" placeholderTextColor="white"></TextInput>
                                    </View>
                                    <View style={[style.inputcontainer,{flex:1}]}>
                                        <TextInput style={style.input} placeholder="State" placeholderTextColor="white"></TextInput>
                                    </View>
                                </View>
                                <View style={{display:'flex',flexDirection:'row'}}>
                                    <View style={[style.inputcontainer,{marginRight:15,flex:1}]}>
                                        <TextInput style={style.input} placeholder="Country" placeholderTextColor="white"></TextInput>
                                    </View>
                                    <View style={[style.inputcontainer,{flex:1}]}>
                                        <TextInput style={style.input} placeholder="PostalCode" placeholderTextColor="white"></TextInput>
                                    </View>
                                </View>
                            </View>
                            <View style={{marginTop:16}}>
